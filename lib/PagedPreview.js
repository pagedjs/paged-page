...
*/
  ...
  render() {
    return x`<div class="page-area"><slot></slot></div>`;
  }
}
...
class PagedDocument extends i$1 {
  ...
  addPage() {
    ...
    this.pagesTemplate.push(x`<paged-page ${n(newPage.ref)} index="${this.pagesTemplate.length + 1}"></paged-page>`);
    this.requestUpdate();
  }
...
export { PagedPreview };
//# sourceMappingURL=PagedPreview.js.map
